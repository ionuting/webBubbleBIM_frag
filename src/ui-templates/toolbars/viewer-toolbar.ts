...
// Toggle function injected from main.ts after the nodal panel is mounted on body
let _toggleNodalGraph: (() => void) | null = null;
export const setNodalGraphToggle = (fn: () => void) => {
  _toggleNodalGraph = fn;
};
